...
func SuggestSummary(c *ctx.Ctx, contributor *models.Contributor, isCurrent bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if contributor.Person != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `contributor/suggest_summary.templ`, Line: 16, Col: 53}
			}
			...
			if isCurrent {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"badge rounded-pill badge-success-light me-3\"><i class=\"if if-check-circle\"></i> <span class=\"badge-text\">Current selection</span></span>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			...
			if affiliations := contributor.Person.Affiliations; len(affiliations) > 0 {
				...
				for i, v := range affiliations {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `contributor/suggest_summary.templ`, Line: 34, Col: 25}
					}
			...
			if len(contributor.Person.UGentID) > 0 {
				...
				for _, ugentID := range contributor.Person.UGentID {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `contributor/suggest_summary.templ`, Line: 44, Col: 18}
					}
			...
			if contributor.Person.ORCID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `contributor/suggest_summary.templ`, Line: 52, Col: 33}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `contributor/suggest_summary.templ`, Line: 73, Col: 26}
			}
			...
			if isCurrent {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"badge rounded-pill badge-success-light\"><i class=\"if if-check-circle\"></i> <span class=\"badge-text\">Current selection</span></span>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
