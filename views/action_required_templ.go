...
func ActionRequired(c *ctx.Ctx, pTotal, dTotal int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if pTotal > 0 || dTotal > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `action_required.templ`, Line: 15, Col: 120}
			}
		...
		if pTotal > 0 || dTotal > 0 {
			...
			if pTotal > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `action_required.templ`, Line: 50, Col: 56}
				}
			...
			if dTotal > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `action_required.templ`, Line: 84, Col: 56}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `action_required.templ`, Line: 115, Col: 74}
			}
