	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, hit := range hits {
			...
			if hit.Acronym != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 17, Col: 74}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 22, Col: 24}
			}
			...
			if hit.Description != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 26, Col: 27}
				}
			...
			if hit.StartDate != "" && hit.EndDate != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 39, Col: 36}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 39, Col: 56}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 51, Col: 56}
			}
			...
			if hit.IWETOID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 56, Col: 62}
				}
			...
			if hit.EUProject != nil && hit.EUProject.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/suggest_projects.templ`, Line: 62, Col: 67}
				}
