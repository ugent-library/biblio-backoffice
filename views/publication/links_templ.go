...
func Links(c *ctx.Ctx, p *models.Publication) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if c.User.CanEditPublication(p) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_add_link", "id", p.ID).String()))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if len(p.Link) > 0 {
			...
			for i, l := range p.Link {
				...
				var templ_7745c5c3_Var4 templ.SafeURL = templ.URL(l.URL)
				...
				if c.User.CanEditPublication(p) {
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_edit_link", "id", p.ID, "link_id", l.ID).String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_confirm_delete_link", "id", p.ID, "snapshot_id", p.SnapshotID, "link_id", l.ID).String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
