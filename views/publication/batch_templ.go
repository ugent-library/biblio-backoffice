...
func BatchBody(c *ctx.Ctx, formValue string, done int, errors []string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if done > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/batch.templ`, Line: 50, Col: 48}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_process_batch").String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
