	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if len(p.LaySummary) > 0 {
			...
			for i, l := range p.LaySummary {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/lay_summaries.templ`, Line: 54, Col: 19}
				}
				...
				templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(localize.LanguageName(l.Lang))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/lay_summaries.templ`, Line: 56, Col: 42}
				}
				...
				if c.User.CanEditPublication(p) {
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_edit_lay_summary", "id", p.ID, "lay_summary_id", l.ID).String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_confirm_delete_lay_summary", "id", p.ID, "snapshot_id", p.SnapshotID, "lay_summary_id", l.ID).String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
