	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if args.Contributor.FirstName() != "" || args.Contributor.LastName() != "" {
			...
			if args.Contributor.FirstName() != "" && args.Contributor.LastName() != "" {
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_confirm_create_contributor", "id", args.Publication.ID, "role", args.Role).String()))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(fmt.Sprintf(`{"first_name": "%s", "last_name": "%s"}`, args.Contributor.FirstName(), args.Contributor.LastName())))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 33, Col: 100}
				}
			...
			if len(args.Hits) > 0 {
				for _, hit := range args.Hits {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 54, Col: 92}
					}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 81, Col: 105}
			}
