...
func AddContributorSuggest(c *ctx.Ctx, args AddContributorSuggestArgs) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if args.Contributor.FirstName() != "" || args.Contributor.LastName() != "" {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(c.PathTo("publication_confirm_create_contributor", "id", args.Publication.ID, "role", args.Role).String())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 29, Col: 121}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 30, Col: 130}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 33, Col: 99}
			}
			...
			if len(args.Hits) > 0 {
				for _, hit := range args.Hits {
					...
					templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(c.PathTo("publication_confirm_create_contributor", "id", args.Publication.ID, "role", args.Role).String())
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 49, Col: 123}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 50, Col: 60}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 53, Col: 92}
					}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 80, Col: 105}
			}
