...
func AddContributorSuggest(c *ctx.Ctx, args AddContributorSuggestArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if args.Contributor.FirstName() != "" || args.Contributor.LastName() != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 32, Col: 99}
			}
			...
			if len(args.Hits) > 0 {
				for _, hit := range args.Hits {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 52, Col: 92}
					}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/add_contributor_suggest.templ`, Line: 79, Col: 105}
			}
