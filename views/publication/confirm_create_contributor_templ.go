...
func ConfirmCreateContributor(c *ctx.Ctx, args ConfirmCreateContributorArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/confirm_create_contributor.templ`, Line: 23, Col: 88}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/confirm_create_contributor.templ`, Line: 27, Col: 71}
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_add_contributor", "id", args.Publication.ID, "role", args.Role, "first_name", args.Contributor.FirstName(), "last_name", args.Contributor.LastName()).String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("publication_create_contributor", "id", args.Publication.ID, "role", args.Role).String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
