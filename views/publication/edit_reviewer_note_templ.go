...
func EditReviewerNoteDialog(c *ctx.Ctx, args EditReviewerNoteDialogArgs) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if args.Conflict {
			...
			templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(c.PathTo("publication_update_reviewer_note", "id", args.Publication.ID).String())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/edit_reviewer_note.templ`, Line: 63, Col: 97}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `publication/edit_reviewer_note.templ`, Line: 64, Col: 83}
			}
