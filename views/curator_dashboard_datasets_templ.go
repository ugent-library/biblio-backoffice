	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			for _, f := range args.Faculties {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `curator_dashboard_datasets.templ`, Line: 67, Col: 58}
				}
			...
			for pti, pt := range args.PTypes {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `curator_dashboard_datasets.templ`, Line: 74, Col: 106}
				}
				...
				for _, f := range args.Faculties {
					if cell, ok := args.Datasets[f][pti]; ok {
						...
						if cell[1] == "" {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `curator_dashboard_datasets.templ`, Line: 79, Col: 54}
							}
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `curator_dashboard_datasets.templ`, Line: 81, Col: 77}
							}
