...
func DraftsToComplete(c *ctx.Ctx, pTotal, dTotal int) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div></div><div class=\"bc-toolbar-right\"><div class=\"d-flex align-items-center\"><a class=\"text-muted mx-2\" href=\"#\" data-bs-container=\"body\" data-bs-toggle=\"popover-custom\" data-bs-placement=\"right\" data-popover-content=\"#drafts-to-complete-tooltip\"><i class=\"if if-info-circle\"></i> <span class=\"visually-hidden\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></a><div class=\"u-hidden\" id=\"drafts-to-complete-tooltip\"><div class=\"popover-body p-0\"><p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var5 := `Items appearing in `
		...
		templ_7745c5c3_Var6 := `Drafts to complete`
		...
		templ_7745c5c3_Var7 := `are waiting to be completed and made visible to the public by you.`
		...
		if pTotal > 0 || dTotal > 0 {
			...
			if pTotal > 0 {
				...
				templ_7745c5c3_Var11 := `Biblio draft`
				...
				var templ_7745c5c3_Var12 templ.SafeURL = templ.URL(c.PathTo("publications", "f[status]", "private").String())
			...
			if dTotal > 0 {
				...
				templ_7745c5c3_Var18 := `Biblio draft`
				...
				var templ_7745c5c3_Var19 templ.SafeURL = templ.URL(c.PathTo("datasets", "f[status]", "private").String())
			...
			templ_7745c5c3_Var23 := `Fully completed.`
