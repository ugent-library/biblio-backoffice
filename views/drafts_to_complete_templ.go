...
func DraftsToComplete(c *ctx.Ctx, pTotal, dTotal int) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if pTotal > 0 || dTotal > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `drafts_to_complete.templ`, Line: 14, Col: 135}
			}
		...
		if pTotal > 0 || dTotal > 0 {
			...
			if pTotal > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `drafts_to_complete.templ`, Line: 49, Col: 81}
				}
			...
			if dTotal > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `drafts_to_complete.templ`, Line: 83, Col: 81}
				}
