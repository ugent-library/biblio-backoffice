...
func ConfirmUpdateContributor(c *ctx.Ctx, args ConfirmUpdateContributorArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/confirm_update_contributor.templ`, Line: 26, Col: 85}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/confirm_update_contributor.templ`, Line: 30, Col: 67}
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(views.URL(c.PathTo("dataset_edit_contributor", "id", args.Dataset.ID, "role", args.Role, "position", fmt.Sprintf("%d", args.Position))).QuerySet("first_name", args.Contributor.FirstName()).QuerySet("last_name", args.Contributor.LastName()).String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if args.EditNext {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("dataset_update_contributor", "id", args.Dataset.ID, "role", args.Role, "position", fmt.Sprintf("%d", args.Position)).String()))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
