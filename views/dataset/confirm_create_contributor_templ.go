...
func ConfirmCreateContributor(c *ctx.Ctx, args ConfirmCreateContributorArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/confirm_create_contributor.templ`, Line: 24, Col: 84}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/confirm_create_contributor.templ`, Line: 28, Col: 65}
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(views.URL(c.PathTo("dataset_add_contributor", "id", args.Dataset.ID, "role", args.Role)).QuerySet("first_name", args.Contributor.FirstName()).QuerySet("last_name", args.Contributor.LastName()).String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("dataset_create_contributor", "id", args.Dataset.ID, "role", args.Role).String()))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(`{"add_next": true}`))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
