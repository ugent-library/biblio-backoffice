	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if c.ProxiedPerson != nil {
				...
				templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs("for " + c.ProxiedPerson.FullName)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 130, Col: 45}
				}
			...
			if c.ProxiedPerson != nil {
				...
				templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(c.ProxiedPerson.FullName)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 138, Col: 111}
				}
				...
				var templ_7745c5c3_Var10 templ.SafeURL = templ.SafeURL(c.PathTo("datasets").String())
			...
			var templ_7745c5c3_Var11 templ.SafeURL = templ.URL(c.PathTo("dataset_add").String())
			...
			if c.UserRole == "curator" {
				...
				var templ_7745c5c3_Var12 templ.SafeURL = templ.URL(datasetSearchExportURL(c, args.SearchArgs).String())
				...
				templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(c.Loc.Get("export_to.xlsx"))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 164, Col: 47}
				}
			...
			if len(args.Scopes) > 0 {
				...
				for _, scope := range args.Scopes {
					...
					var templ_7745c5c3_Var14 = []any{"nav-link", templ.KV("active", args.SearchArgs.HasFilter("scope", scope)), templ.KV("text-success", c.ProxiedPerson != nil), templ.KV("border-success", args.SearchArgs.HasFilter("scope", scope) && c.ProxiedPerson != nil)}
					...
					var templ_7745c5c3_Var16 templ.SafeURL = views.URL(c.PathTo("datasets")).Query(args.SearchArgs.Clone().WithFilter("scope", scope)).SafeURL()
					...
					if c.ProxiedPerson != nil {
						...
						case "all":
							...
							templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(c.ProxiedPerson.FullName)
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 185, Col: 43}
							}
							_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var17))
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
							_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" datasets")
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
						case "contributed":
							var templ_7745c5c3_Var18 string
							templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(c.ProxiedPerson.FullName)
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 187, Col: 39}
							}
						...
						case "created":
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 189, Col: 53}
							}
						...
						templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(c.Loc.Get("dataset.search.scopes." + scope))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 192, Col: 54}
						}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 220, Col: 92}
			}
			...
			if len(args.Hits.Hits) > 0 {
				...
				templ_7745c5c3_Var23, templ_7745c5c3_Err = templ.JoinStringErrs(c.Loc.Get("dataset.search.empty.title." + args.CurrentScope))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 241, Col: 102}
				}
				...
				templ_7745c5c3_Var24, templ_7745c5c3_Err = templ.JoinStringErrs(c.Loc.Get("dataset.search.empty.description." + args.CurrentScope))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 242, Col: 79}
				}
				...
				var templ_7745c5c3_Var25 templ.SafeURL = templ.URL(c.PathTo("dataset_add").String())
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/search.templ`, Line: 275, Col: 92}
			}
