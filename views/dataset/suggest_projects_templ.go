	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, hit := range hits {
			...
			if hit.EUProject != nil && hit.EUProject.Acronym != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/suggest_projects.templ`, Line: 67, Col: 72}
				}
			...
			if hit.EUProject != nil && hit.EUProject.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `dataset/suggest_projects.templ`, Line: 73, Col: 67}
				}
