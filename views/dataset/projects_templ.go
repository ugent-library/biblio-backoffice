...
func Projects(c *ctx.Ctx, dataset *models.Dataset) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if c.User.CanEditDataset(dataset) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("dataset_add_project", "id", dataset.ID).String()))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if len(dataset.RelatedProjects) > 0 {
			...
			for i, rel := range dataset.RelatedProjects {
				var templ_7745c5c3_Var3 = []any{fmt.Sprintf("row-%d", i), "list-group-item"}
				...
				var templ_7745c5c3_Var8 templ.SafeURL = templ.URL(fmt.Sprintf("%s/%s", c.FrontendURL, rel.Project.ID))
				...
				if c.User.CanEditDataset(dataset) {
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("dataset_confirm_delete_project", "id", dataset.ID, "snapshot_id", dataset.SnapshotID, "project_id", url.PathEscape(rel.ProjectID)).String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
