...
func pageLayout(c *ctx.Ctx, title, activeNav string, meta templ.Component) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		if c.User != nil {
			...
			_, err = templBuffer.WriteString("<a class=\"btn btn-link btn-sm ms-4\" href=\"")
			if err != nil {
				return err
			}
		...
		_, err = templBuffer.WriteString("<div class=\"c-sidebar__menu\">")
		if err != nil {
			return err
		}
		if c.User != nil {
			_, err = templBuffer.WriteString("<nav><ul class=\"c-sidebar-menu\">")
			if err != nil {
				return err
			}
			...
			_, err = templBuffer.WriteString("</ul></nav>")
			if err != nil {
				return err
			}
		}
		_, err = templBuffer.WriteString("</div><div class=\"c-sidebar__bottom\"><img src=\"")
		if err != nil {
			return err
		}
