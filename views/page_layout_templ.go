...
func pageLayout(c *ctx.Ctx, title string, meta templ.Component) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 14, Col: 22}
		}
		...
		if c.OriginalUser != nil {
			...
			var templ_7745c5c3_Var3 templ.SafeURL = templ.URL(c.PathTo("delete_impersonation").String())
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(c.User.FullName)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 41, Col: 97}
			}
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(c.OriginalUser.FullName)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 42, Col: 105}
			}
		...
		var templ_7745c5c3_Var7 templ.SafeURL = templ.URL(c.PathTo("home").String())
		...
		var templ_7745c5c3_Var8 templ.SafeURL = templ.URL(c.FrontendURL + "/contact")
		...
		if c.User != nil {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(c.User.FullName)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 85, Col: 97}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 94, Col: 77}
			}
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(c.User.Email)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page_layout.templ`, Line: 95, Col: 105}
			}
			...
			var templ_7745c5c3_Var13 templ.SafeURL = templ.URL(c.PathTo("login").String())
		...
		var templ_7745c5c3_Var14 = []any{"c-sidebar", templ.KV("c-sidebar--dark-gray", c.UserRole == "curator")}
		...
		if c.User != nil {
			...
			var templ_7745c5c3_Var15 = []any{"c-sidebar__item", templ.KV("c-sidebar__item--active", c.Nav == "dashboard")}
			...
			var templ_7745c5c3_Var16 templ.SafeURL = templ.URL(c.PathTo("dashboard").String())
			...
			var templ_7745c5c3_Var17 = []any{"c-sidebar__item", templ.KV("c-sidebar__item--active", c.Nav == "publications")}
			...
			var templ_7745c5c3_Var18 templ.SafeURL = templ.URL(c.PathTo("publications").String())
			...
			var templ_7745c5c3_Var19 = []any{"c-sidebar__item", templ.KV("c-sidebar__item--active", c.Nav == "datasets")}
			...
			var templ_7745c5c3_Var20 templ.SafeURL = templ.URL(c.PathTo("datasets").String())
			...
			if c.UserRole == "curator" {
				var templ_7745c5c3_Var21 = []any{"c-sidebar__item", templ.KV("c-sidebar__item--active", c.Nav == "batch")}
				...
				var templ_7745c5c3_Var22 templ.SafeURL = templ.URL(c.PathTo("publication_batch").String())
				...
				if c.FlagCandidateRecords() {
					var templ_7745c5c3_Var23 = []any{"c-sidebar__item", templ.KV("c-sidebar__item--active", c.Nav == "candidate_records")}
					...
					var templ_7745c5c3_Var24 templ.SafeURL = templ.URL(c.PathTo("candidate_records").String())
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(c.PathTo("candidate_records_icon").String()))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" hx-trigger=\"load, every 5s\">")
