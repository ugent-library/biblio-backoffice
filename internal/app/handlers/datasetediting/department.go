...
func (h *Handler) AddDepartment(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "dataset/add_department", YieldAddDepartment{
		Context: ctx,
		Hits:    hits,
	})
}
...
func (h *Handler) SuggestDepartments(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderPartial(w, "dataset/suggest_departments", YieldAddDepartment{
		Context: ctx,
		Hits:    hits,
	})
}
...
func (h *Handler) CreateDepartment(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderView(w, "dataset/refresh_departments", YieldDepartments{
		Context: ctx,
	})
}
...
func (h *Handler) ConfirmDeleteDepartment(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "dataset/confirm_delete_department", YieldDeleteDepartment{
		Context:  ctx,
		Position: b.Position,
	})
}
