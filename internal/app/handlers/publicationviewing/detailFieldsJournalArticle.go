...
func detailFieldsJournalArticle(ctx Context) []*fields.Fields {
	p := ctx.Publication
	return []*fields.Fields{
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.journal_article_type"),
					Value: ctx.TS("journal_article_types", p.JournalArticleType),
				},
				&fields.Text{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.pubmed_id"),
					Value: p.PubMedID,
				},
				&fields.Text{
					Label: ctx.T("builder.arxiv_id"),
					Value: p.ArxivID,
				},
				&fields.Text{
					Label: ctx.T("builder.esci_id"),
					Value: p.ESCIID,
				},
			},
		},
