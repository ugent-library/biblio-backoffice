...
func detailFieldsDissertation(ctx Context) []*fields.Fields {
	p := ctx.Publication
	return []*fields.Fields{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.publication_abbreviation"),
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.series_title"),
					Value: p.SeriesTitle,
				},
			},
		},
		{
			...
			Fields: []fields.Field{
				&fields.Text{
					Label:    ctx.T("builder.defense_date"),
					Value:    p.DefenseDate,
					Required: true,
				},
				&fields.Text{
					Label:    ctx.T("builder.defense_time"),
					Value:    p.DefenseTime,
					Required: true,
				},
				&fields.Text{
					Label:    ctx.T("builder.defense_place"),
		...
		},
		{
			...
			Fields: []fields.Field{
				&fields.Text{
					Label: ctx.T("builder.has_confidential_data"),
					Value: ctx.TS("confirmations", p.HasConfidentialData),
				},
				&fields.Text{
					Label: ctx.T("builder.has_patent_application"),
					Value: ctx.TS("confirmations", p.HasPatentApplication),
				},
				&fields.Text{
					Label: ctx.T("builder.has_publications_planned"),
					Value: ctx.TS("confirmations", p.HasPublicationsPlanned),
				},
				&fields.Text{
					Label: ctx.T("builder.has_published_material"),
					Value: ctx.TS("confirmations", p.HasPublishedMaterial),
				},
			},
		},
		{
