...
func detailFieldsConference(ctx Context) []*fields.Fields {
	p := ctx.Publication
	return []*fields.Fields{
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.conference_type"),
					Value: ctx.TS("conference_types", p.ConferenceType),
				},
				&fields.Text{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label:    ctx.T("builder.conference.publication"),
					Value:    p.Publication,
					Required: true,
				},
				&fields.Text{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.conference.series_title"),
					Value: p.SeriesTitle,
				},
			},
		},
