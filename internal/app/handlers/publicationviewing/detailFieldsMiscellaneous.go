...
func detailFieldsMiscellaneous(ctx Context) []*fields.Fields {
	p := ctx.Publication
	return []*fields.Fields{
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.miscellaneous_type"),
					Value: ctx.TS("miscellaneous_types", p.MiscellaneousType),
				},
				&fields.Text{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label:    ctx.T("builder.publication"),
					Value:    p.Publication,
					Required: true,
				},
				&fields.Text{
		...
		},
		{
			...
			Fields: []fields.Field{
				...
				&fields.Text{
					Label: ctx.T("builder.edition"),
					Value: p.Edition,
				},
				&fields.Text{
					Label: ctx.T("builder.pages"),
				...
				&fields.Text{
					Label: ctx.T("builder.article_number"),
					Value: p.ArticleNumber,
				},
				&fields.Text{
					Label: ctx.T("builder.issue_title"),
					Value: p.IssueTitle,
				},
				&fields.Text{
					Label: ctx.T("builder.report_number"),
