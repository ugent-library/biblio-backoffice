...
func (h *Handler) EditAdditionalInfo(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "publication/edit_additional_info", YieldEditAdditionalInfo{
		Context: ctx,
...
func (h *Handler) UpdateAdditionalInfo(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	if validationErrs := p.Validate(); validationErrs != nil {
		...
		render.MustRenderLayout(w, "refresh_modal", "publication/edit_additional_info", YieldEditAdditionalInfo{
			Context: ctx,
			Form:    form,
		})
		return
	...
	render.MustRenderView(w, "publication/refresh_additional_info", YieldAdditionalInfo{
		Context:               ctx,
