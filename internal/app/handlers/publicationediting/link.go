...
func (h *Handler) AddLink(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "publication/add_link", YieldAddLink{
		Context: ctx,
		Form:    form,
	})
}
...
func (h *Handler) CreateLink(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	if validationErrs := ctx.Publication.Validate(); validationErrs != nil {
		render.MustRenderLayout(w, "refresh_modal", "publication/add_link", YieldAddLink{
			Context: ctx,
	...
	render.MustRenderView(w, "publication/refresh_links", YieldLinks{
		Context: ctx,
	})
}
...
func (h *Handler) EditLink(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "publication/edit_link", YieldEditLink{
		Context:  ctx,
		Position: b.Position,
...
func (h *Handler) UpdateLink(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	if validationErrs := ctx.Publication.Validate(); validationErrs != nil {
		...
		render.MustRenderLayout(w, "refresh_modal", "publication/edit_link", YieldEditLink{
			Context:  ctx,
			Position: b.Position,
			Form:     form,
		})
...
func (h *Handler) ConfirmDeleteLink(w http.ResponseWriter, r *http.Request, ctx Context) {
	...
	render.MustRenderLayout(w, "show_modal", "publication/confirm_delete_link", YieldDeleteLink{
		Context:  ctx,
		Position: b.Position,
	})
}
