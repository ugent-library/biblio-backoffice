...
var fixedFacetValues = map[string][]string{
	...
	"extern":             {"true", "false"},
	"faculty_id":         append([]string{models.MissingValue}, vocabularies.Map["faculties"]...),
	"file_relation":      vocabularies.Map["publication_file_relations"],
	"has_message":        {"true", "false"},
	"has_files":          {"true", "false"},
	"legacy":             {"true", "false"},
	"locked":             {"true", "false"},
	"publication_status": append([]string{models.MissingValue}, vocabularies.Map["publication_publishing_statuses"]...),
