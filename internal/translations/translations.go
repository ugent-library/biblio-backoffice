...
func init() {
	...
	message.SetString(language.English, "form_builder.alternative_title", "Alternative title")
	message.SetString(language.English, "form_builder.article_number", "Article number")
	message.SetString(language.English, "form_builder.classification", "Classification")
	message.SetString(language.English, "form_builder.conference_type", "Conference type")
	message.SetString(language.English, "form_builder.defense_date", "Date of defense")
	message.SetString(language.English, "form_builder.defense_time", "Time of defense")
	message.SetString(language.English, "form_builder.defense_place", "Place of defense")
	message.SetString(language.English, "form_builder.doi", "DOI")
	message.SetString(language.English, "form_builder.edition", "Edition")
	message.SetString(language.English, "form_builder.extern", "Published while none of the authors are employed at UGent")
	message.SetString(language.English, "form_builder.isbn", "ISBN")
	message.SetString(language.English, "form_builder.issn", "ISSN")
	message.SetString(language.English, "form_builder.issue", "Issue")
	message.SetString(language.English, "form_builder.issue_title", "Special issue title")
	message.SetString(language.English, "form_builder.journal_article_type", "Article type")
	message.SetString(language.English, "form_builder.language", "Languages")
	message.SetString(language.English, "form_builder.miscellaneous_type", "Miscellaneous type")
	message.SetString(language.English, "form_builder.page_first", "First page")
	message.SetString(language.English, "form_builder.page_last", "Last page")
	message.SetString(language.English, "form_builder.page_count", "Total pages")
	message.SetString(language.English, "form_builder.place_of_publication", "Place of publication")
	message.SetString(language.English, "form_builder.publisher", "Publisher")
	message.SetString(language.English, "form_builder.publication_status", "Publishing status")
	message.SetString(language.English, "form_builder.report_number", "Report number")
	message.SetString(language.English, "form_builder.series_title", "Series title")
	message.SetString(language.English, "form_builder.title", "Title")
	message.SetString(language.English, "form_builder.volume", "Volume")
	message.SetString(language.English, "form_builder.wos_type", "Web of Science type")
	message.SetString(language.English, "form_builder.year", "Publication year")

	message.SetString(language.English, "form_builder.book.publication", "Book title")

	message.SetString(language.English, "form_builder.conference.publication", "Proceedings title")

	message.SetString(language.English, "form_builder.journal_article.publication", "Journal title")
	message.SetString(language.English, "form_builder.journal_article.publication_abbreviation", "Short journal title")

	message.SetString(language.English, "form_builder.miscellaneous.publication", "Publication title")
	message.SetString(language.English, "form_builder.miscellaneous.publication_abbreviation", "Publication short title")
}
