...
func init() {
	...
	message.SetString(language.English, "faculty.CA", "Central Administration")
	message.SetString(language.English, "faculty.DS", "Doctoral Schools")
	message.SetString(language.English, "faculty.DI", "Faculty of Veterinary Medicine")
	message.SetString(language.English, "faculty.EB", "Faculty of Economics and Business Administration")
	message.SetString(language.English, "faculty.FW", "Faculty of Pharmaceutical Sciences")
	message.SetString(language.English, "faculty.GE", "Faculty of Medicine and Health Sciences")
	message.SetString(language.English, "faculty.LA", "Faculty of Bioscience Engineering")
	message.SetString(language.English, "faculty.LW", "Faculty of Arts and Philosophy")
	message.SetString(language.English, "faculty.PS", "Faculty of Political and Social Sciences")
	message.SetString(language.English, "faculty.PP", "Faculty of Psychology and Educational Sciences")
	message.SetString(language.English, "faculty.RE", "Faculty of Law")
	message.SetString(language.English, "faculty.TW", "Faculty of Engineering and Architecture")
	message.SetString(language.English, "faculty.WE", "Faculty of Sciences")
	message.SetString(language.English, "faculty.GUK", "Global Campus Korea")
	message.SetString(language.English, "faculty.UZGent", "Ghent University Hospital")
	message.SetString(language.English, "faculty.HOART", "University College Artevelde")
	message.SetString(language.English, "faculty.HOGENT", "University College Ghent")
	message.SetString(language.English, "faculty.HOWEST", "University College West Flanders")
	message.SetString(language.English, "faculty.IBBT", "iMinds")
	message.SetString(language.English, "faculty.IMEC", "Imec")
	message.SetString(language.English, "faculty.VIB", "VIB")
}
