...
- #1762: Fixed disappearing access level
...
- Add cleanup step to fix old publications that have files with no access level
...
- Fix add publication link in empty search results page
...
- #1754: map Plato confidentiality reason to reviewer note
...
- #1742: Allow restore of rejected suggestion by reviewer as normal user
