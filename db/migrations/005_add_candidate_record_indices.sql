...
create index candidate_records_date_editor_idx on candidate_records using gin((metadata->'editor') jsonb_path_ops);
...
drop index candidate_records_date_editor_idx;
