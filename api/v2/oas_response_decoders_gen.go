...
func decodeIndexOrganizationsResponse(resp *http.Response) (res *IndexOrganizationsNoContent, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &IndexOrganizationsNoContent{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeIndexPeopleResponse(resp *http.Response) (res *IndexPeopleNoContent, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &IndexPeopleNoContent{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeIndexProjectsResponse(resp *http.Response) (res *IndexProjectsNoContent, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &IndexProjectsNoContent{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
