...
var file_api_v1_biblio_proto_rawDesc = []byte{
	...
	0x6e, 0x52, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x5f,
	0x0a, 0x06, 0x42, 0x69, 0x62, 0x6c, 0x69, 0x6f, 0x12, 0x55, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50,
...
var file_api_v1_biblio_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_api_v1_biblio_proto_depIdxs = []int32{
	...
	10, // 6: biblio.v1.Publication.date_created:type_name -> google.protobuf.Timestamp
	10, // 7: biblio.v1.Publication.date_updated:type_name -> google.protobuf.Timestamp
	10, // 8: biblio.v1.Publication.date_from:type_name -> google.protobuf.Timestamp
	10, // 9: biblio.v1.Publication.date_until:type_name -> google.protobuf.Timestamp
	7,  // 10: biblio.v1.GetPublicationResponse.publication:type_name -> biblio.v1.Publication
	8,  // 11: biblio.v1.Biblio.GetPublication:input_type -> biblio.v1.GetPublicationRequest
	9,  // 12: biblio.v1.Biblio.GetPublication:output_type -> biblio.v1.GetPublicationResponse
